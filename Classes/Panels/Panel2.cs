namespace BerlinClock.Classes.Panels
{
    ...
    /// <summary>
    /// This is not a code repetition. This class is to show another implementation of panel - with different visualization.
    /// </summary>
    public class Panel2 : IPanel
    {
        private IList<IRow> Rows { get; set; }

        public Panel2(TimeSpan time)
        {
            IVisualization visualization = new Visualization2();
            Rows = new List<IRow>
                       {
